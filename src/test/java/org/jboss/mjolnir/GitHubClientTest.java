 ...
 */
@Ignore // only intended for development / illustrational purposes, not to be run during the build process
public class GitHubClientTest {

    private static String TOKEN = "???"; // provide GitHub "personal access token" (needs to have admin:org persmission)
